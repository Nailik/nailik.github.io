...
val Logos.LogoEikonaDarkMode: ImageVector
    get() {
        if (_LogoEikonaDarkMode != null) {
            return _LogoEikonaDarkMode!!
        }
        _LogoEikonaDarkMode = ImageVector.Builder(
            name = "LogoEikonaDarkMode",
...
private var _LogoEikonaDarkMode: ImageVector? = null
